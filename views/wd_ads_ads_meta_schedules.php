...
<p class="descritpion wd_ads_toggle_schedule <?php echo $use_schedule==0 ? 'wd_ads_hidden' : ''  ?>">You can have one schedule with limited options for each advert in the free version of the plugin. Upgrade to <b>Ad Manager Pro</b> to add unlimited number of schedules with more comprehensive settings.</p>
