...
class wd_ads_admin
{
    ...
    private function __construct()
    {
        ...
        //$this->overview();
        $this->includes();
        $export_csv = isset($_POST['export_scv']) ? intval($_POST['export_scv']) : 0;
        if($export_csv==1)
            $this->export_csv();
    ...
    function export_csv() {
        ...
        $dates       =  isset($_POST['dates']) ? json_decode( sanitize_text_field($_POST['dates']), true ) : array();
        $impressions = isset($_POST['impressions_by_date']) ? json_decode( sanitize_text_field($_POST['impressions_by_date']), true ) : array();
        $clicks      = isset($_POST['clicks_by_date']) ? json_decode( sanitize_text_field($_POST['clicks_by_date']), true ) : array();
        $filename    = 'report';
        $date_range  = isset($_POST['range']) ? sanitize_text_field($_POST['range']) : '';

        if ( ! is_dir( WD_ADS_DIR . '/csv' ) ) {
            wp_mkdir_p( WD_ADS_DIR . '/csv' );
        }
                    ...
                    <div class="wd_ads-right">
                        <div class="wd-table">
                            <div class="wd-cell wd-cell-valign-middle">
                                <a href="https://10web.io/contact-us/?utm_source=wd_ads&utm_medium=free_plugin" target="_blank">
                                    <img src="<?php echo WD_ADS_URL; ?>/images/i_support.png" >
                                    <?php _e("Support Forum", "gmwd"); ?>
                                </a>
                            </div>
                            <div class="wd-cell wd-cell-valign-middle">
                                <a href="https://10web.io/plugins/wordpress-ad-manager/?utm_source=wd_ads&utm_medium=free_plugin" target="_blank">
                        ...
                        echo '<div class="wd_ads-left">';
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/sections/360002531151-Ad-Manager/?utm_source=wd_ads&utm_medium=free_plugin">Read More in
                                    User Manual</a>
                            </div>
                            ';
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/articles/360017961892-Creating-Ads">Read
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/articles/360018236591-Ad-Groups">Read More in User Manual</a>
                            </div>
                            ';
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/articles/360017962232-Schedules">Read More in User
                                    Manual</a>
                            </div>
                            ';
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/articles/360018237131-Settings">Read More in User
                                    Manual</a>
                            </div>
                            ';
                            ...
                            <div style="font-size: 14px; font-weight: bold;">
                                ...
                                <a style="color: #5CAEBD; text-decoration: none;border-bottom: 1px dotted;" target="_blank"
                                   href="https://help.10web.io/hc/en-us/articles/360018237131-Settings">Read More in User Manual</a>
                            </div>
                            ';
    ...
    public static function wd_ads_activate()
    {
        ...
        if (get_option('wd_ads_def_advert') === false) {
            ...
            if ($post_id) {
                ...
                $area_code = '<a href="https://10web.io/wordpress-plugins/?utm_source=wd_ads&utm_medium=free_plugin"><img src="%featured_image%"></a>';
